    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try{
                ...
                Utils.handleStringIndexOutOfBoundsException();
            }
        }

    }

    private static void mainLogic(String[] command, String input) throws StringIndexOutOfBoundsException, NoTaskNameException {
