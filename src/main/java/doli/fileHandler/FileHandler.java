...
public class FileHandler {
    ...
    public static void loadExistingFile(File file, ArrayList<Task> agenda) {
        try {
    ...
    public static void addTodo(String description, boolean isDone, ArrayList<Task> agenda) {
        ToDo todo = new ToDo(description);
        todo.setDone(isDone);
        agenda.add(todo);
    }
    public static void addDeadline(String description, boolean isDone, String date, ArrayList<Task> agenda) {
        Deadline deadline = new Deadline(description, date);
        deadline.setDone(isDone);
        agenda.add(deadline);
    }
    public static void addEvent(String description, boolean isDone,
