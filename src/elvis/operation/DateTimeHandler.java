...
public class DateTimeHandler {
    ...
    private static final Pattern DATE_TIME_PATTERN = Pattern.compile(
            "(0?[1-9]|[1-2][0-9]|3[0-1])/(0?[1-9]|1[0-2])/\\d{4} (0?[0-9]|1[0-9]|2[0-3])[0-5][0-9]|" +     // dd/mm/yyyy HHMM
            "\\d{4}/(0?[1-9]|1[0-2])/(0?[1-9]|[1-2][0-9]|3[0-1]) (0?[0-9]|1[0-9]|2[0-3])[0-5][0-9]|" +     // yyyy/mm/dd HHMM
            "(0?[1-9]|[1-2][0-9]|3[0-1])-(0?[1-9]|1[0-2])-\\d{4} (0?[0-9]|1[0-9]|2[0-3])[0-5][0-9]|" +     // dd-mm-yyyy HHMM
            "\\d{4}-(0?[1-9]|1[0-2])-(0?[1-9]|[1-2][0-9]|3[0-1]) (0?[0-9]|1[0-9]|2[0-3])[0-5][0-9]|" +     // yyyy-mm-dd HHMM
            "(0?[1-9]|[1-2][0-9]|3[0-1])/(0?[1-9]|1[0-2])/\\d{4} (0?[0-9]|1[0-9]|2[0-3]):[0-5][0-9]|" +    // dd/mm/yyyy HH:MM
            "\\d{4}/(0?[1-9]|1[0-2])/(0?[1-9]|[1-2][0-9]|3[0-1]) (0?[0-9]|1[0-9]|2[0-3]):[0-5][0-9]|" +    // yyyy/mm/dd HH:MM
            "(0?[1-9]|[1-2][0-9]|3[0-1])-(0?[1-9]|1[0-2])-\\d{4} (0?[0-9]|1[0-9]|2[0-3]):[0-5][0-9]|" +    // dd-mm-yyyy HH:MM
            "\\d{4}-(0?[1-9]|1[0-2])-(0?[1-9]|[1-2][0-9]|3[0-1]) (0?[0-9]|1[0-9]|2[0-3]):[0-5][0-9]"       // yyyy-mm-dd HH:MM
    );
